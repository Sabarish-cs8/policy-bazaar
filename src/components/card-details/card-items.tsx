...
const CardItem = ({ card }: CardItemProps) => {
  ...
  return (
    ...
    <div className='py-3 px-3 w-[100px] lg:py-[47px] lg:px-[22px] lg:w-[200px]'>
    <Image src={card.icon} alt={`${card.cardName}`} width={97}
    height={60}/>
    </div>
    <div className='flex flex-col w-full'>
      <div className=' flex flex-col lg:flex-row w-full gap-2 px-2 lg:space-x-16 my-4 '>
      ...
      <div className=''>
        ...
        <div className='flex flex-row'>
          ...
          <ul className='grid  lg:grid-cols-2 gap-x-4 gap-y-2 list-disc  list-inside marker:text-[#65c85b] text-[#132e5c]'>
          ...
          <Button variant='ghost' className='text-[#4291f5] lg:ml-10 bg-transparent text-sm hover:bg-transparent hover:text-[#4291f5] flex' onClick={toggleShowAll}>
          ...
          <Button className='hidden lg:flex text-white justify-end bg-[#f9491f] hover:bg-[#f9491f]'>
              Apply Now
          </Button>
        </div>
      </div>
